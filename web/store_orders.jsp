...
<div class="banner-top">
    <div class="container">
        <h3>我的订单</h3>
        <h4><a href="index.jsp">首页</a><label>/</label><a href="store_me.jsp">卖家个人中心</a><label>/</label>我的订单</h4>
        <div class="clearfix"></div>
    </div>
</div>
...
<div class="faq-w3 main-grid-border">
    <div class="container">
        ...
        <table id="customer_table" class="table">
            ...
            <%
                //循环显示数据
                List<Order> order_list = (List) request.getSession().getAttribute("store_list_orders");
            ...
            <tr>
                ...
                <td>${order.total}</td>
                <td>
                    <button class="btn btn-danger my-cart-btn my-cart-b" onclick='get_confirm(${order.orderid})'>确认发货</button>
                    <button class="btn btn-danger my-cart-btn my-cart-b" onclick='get_details(${order.orderid})'>查看详情</button>
                </td>
            </tr>
            <%
                }
...
<script type="text/javascript" charset="utf-8">
    function get_confirm(x) {
        window.location.href="change_order_state?orderid="+x+"&state=3";
    }
